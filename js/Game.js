class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 -250, y: height - 1000, image: obstacle2Image },
      { x: width / 2 + 339, y: height - 2000, image: obstacle2Image },
      { x: width / 2 - 146, y: height - 2700, image: obstacle2Image },
     
      { x: width / 2 - 260, y: height - 5900, image: obstacle2Image },
      { x: width / 2, y: height -5000, image: obstacle2Image },
      { x: width / 2 - 400, y: height - 3900, image: obstacle2Image },
      { x: width / 2, y: height - 6900, image: obstacle2Image },
    ];
